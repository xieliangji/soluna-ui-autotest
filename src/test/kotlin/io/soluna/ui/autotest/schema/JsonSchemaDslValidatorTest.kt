    ...
    fun `validates referenced case element and fragment examples`() {
        val examples = mapOf(
            "/schemas/v1/case.schema.json" to listOf(
                ...
                Path.of("AIot-Tests/apps/com.ugreen.iot/cases/device/common/TC001_DEVICE_RENAME.yaml"),
                Path.of("AIot-Tests/apps/com.ugreen.iot/cases/device/ugreen-hitune-t8/TC001_HIGH_QUALITY_CODEC_ANDROID.yaml"),
            ),
