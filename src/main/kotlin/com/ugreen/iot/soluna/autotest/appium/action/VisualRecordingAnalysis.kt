...
class FfmpegVideoFrameExtractor(
    private val executableCandidates: List<String> = listOf("/opt/homebrew/bin/ffmpeg", "ffmpeg"),
) : VideoFrameExtractor {
    override fun extract(
        ...
        val executable = executableCandidates.firstOrNull { candidate ->
            runCatching {
        ...
        } ?: error("ffmpeg is required for screen recording frame extraction")
